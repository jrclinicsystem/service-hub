...
function FinancePage() {
  return (
    <div className="relative min-h-screen bg-background">
      ...
      <main className="finance-page relative isolate min-h-screen min-w-0 overflow-x-hidden lg:ml-[252px] lg:pt-[120px] [&_.bg-amber-500]:!bg-primary-soft [&_.bg-amber-500]:!text-primary [&_label]:!text-foreground [&_label]:!opacity-100 [&_input[type=date]]:!border-border [&_input[type=date]]:!bg-card [&_input[type=date]]:!text-foreground [&_input[type=date]]:!opacity-100 [&_[role=tablist]]:min-h-16 [&_[role=tablist]]:gap-1 [&_[role=tablist]]:rounded-[20px] [&_[role=tablist]]:border [&_[role=tablist]]:border-border/80 [&_[role=tablist]]:bg-card/98 [&_[role=tablist]]:p-1.5 [&_[role=tablist]]:shadow-[0_8px_26px_rgb(15_77_62_/_0.09)] [&_[role=tablist]]:backdrop-blur-xl lg:[&_[role=tablist]]:fixed lg:[&_[role=tablist]]:left-[calc(50%+126px)] lg:[&_[role=tablist]]:top-12 lg:[&_[role=tablist]]:z-[70] lg:[&_[role=tablist]]:w-[calc(100vw-276px)] lg:[&_[role=tablist]]:max-w-[1476px] lg:[&_[role=tablist]]:-translate-x-1/2 [&_[role=tab]]:min-h-12 [&_[role=tab]]:rounded-[15px] [&_[role=tab]]:px-5 [&_[role=tab]]:text-[15px] [&_[role=tab]]:font-semibold [&_[role=tab]]:text-muted-foreground [&_[role=tab]]:transition-all [&_[role=tab]]:duration-200 [&_[role=tab]]:hover:bg-primary-soft/70 [&_[role=tab]]:hover:text-primary [&_[role=tab][data-state=active]]:bg-primary [&_[role=tab][data-state=active]]:text-primary-foreground [&_[role=tab][data-state=active]]:shadow-[0_4px_12px_rgb(15_77_62_/_0.18)]">
        <style>{`
