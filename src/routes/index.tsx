        ...
        <section className="grid w-full items-center gap-9 sm:gap-12 lg:grid-cols-[1.18fr_0.82fr] lg:gap-16 xl:gap-20">
          <div className="home-copy min-w-0 text-center sm:text-left lg:-translate-y-1">
            ...
            {catalog.businessAddress ? (
              <div className="mx-auto mt-4 flex max-w-[650px] flex-col gap-3 rounded-2xl border border-primary/20 bg-primary p-3.5 text-left shadow-[0_18px_36px_-32px_rgba(15,77,62,0.55)] sm:mx-0 sm:mt-5 sm:flex-row sm:items-center sm:justify-between sm:p-4">
                <div className="flex min-w-0 flex-1 items-center gap-3 rounded-xl bg-background/90 p-2.5 sm:p-3">
                ...
                {locationUrl ? (
                  <a
                    ...
                    className="inline-flex h-10 shrink-0 items-center justify-center gap-2 rounded-full border border-white/25 bg-background px-4 text-xs font-semibold text-primary transition hover:bg-background/90"
                  >
