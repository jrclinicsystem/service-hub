...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "JR Clinic - Procedimentos | Profissionais | Agendamento Online" },
      { name: "description", content: "Conheça os procedimentos, profissionais e faça seu agendamento online na JR Clinic." },
      { name: "author", content: "JR Clinic" },
      { property: "og:title", content: "JR Clinic - Procedimentos | Profissionais | Agendamento Online" },
      { property: "og:description", content: "Conheça os procedimentos, profissionais e faça seu agendamento online na JR Clinic." },
