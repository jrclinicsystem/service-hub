-- Resultado financeiro = líquido - despesas efetivamente registradas no relatório.
-- Comissões previstas/geradas continuam exibidas separadamente e na coluna Clínica,
-- mas não reduzem o Resultado enquanto não virarem uma despesa registrada.
