...
# Professional portal: immediately refresh the selectable slots whenever an
# appointment changes (including cancel/decline), when the tab regains focus,
# and after the professional creates a new appointment.
...
# Public booking: if a cancellation happens while this page is already open,
# refetch slots on realtime changes and whenever the tab/window becomes active.
...
# Admin new-appointment dialog: keep an already-open dialog in sync too.
